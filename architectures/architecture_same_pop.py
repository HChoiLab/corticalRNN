...
class microcircuit(nn.Module):
    def __init__(self, seq_len=1, n_features=64, hidden_dim=8, pop_list = [3,3,3], pEdge=0.3, bsize=100, device=device, manual_seed=0, task='recon', n_classes=None, latticeDim=2):
